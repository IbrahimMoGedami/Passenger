...
extension UILabel
{
    ...
    func setHTMLFromString(text: String) {
        ...
        let modifiedFont = "<style>" +
            "html *" +
            "{" +
            "dir: \(direction) !important;" +
            "font-size: \(self.font!.pointSize) !important;" +
            "color: #\(self.textColor.hexString) !important;" +
            "font-family: \(self.font!.fontName), !important;" +
        "}</style> \(text)"
