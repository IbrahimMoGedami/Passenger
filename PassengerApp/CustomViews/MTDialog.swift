...
//            cover.tag = Utils.WINDOW_ALERT_DIALOG_BG_TAG
    ...
    private func configure(_ button: inout UIButton, withTitle title: String? = nil){
        ...
        button.setTitleColor(UIColor(hex: 0x212121), for: UIControl.State())
    ...
    private func addControls() {
        ...
        configure(&titleLabel, withText: title, font: Fonts().bold, fontSize: 17, textColor: UIColor(hex: 0x212121))
        
        configure(&contentLabel, withText: message, font: Fonts().regular, fontSize: 15, textColor: UIColor(hex: 0x212121))
