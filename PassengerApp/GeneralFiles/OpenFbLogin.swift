...
class OpenFbLogin: NSObject, LoginButtonDelegate {
...
//                print("User Logged Out")
    ...
    func getUserData()
    {
        ...
        let graphRequest : GraphRequest = GraphRequest(graphPath: "me", parameters: ["fields":"id,email,first_name,last_name,name, picture.width(2048).height(2048)"])
