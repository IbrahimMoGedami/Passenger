...
//        TWTRTwitter.sharedInstance().start(withConsumerKey: Configurations.getInfoPlistValue(key: "TWITTER_CONSUMER_KEY"), consumerSecret: Configurations.getInfoPlistValue(key: "TWITTER_CONSUMER_SECRET_KEY"))
//
...
//
//            }else if(error != nil){
//                if(error!.localizedDescription != "" && !error!.localizedDescription.uppercased().contains(find: "USER CANCELLED LOGIN FLOW")){
