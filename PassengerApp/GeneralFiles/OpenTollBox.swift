...
class OpenTollBox: NSObject, MyBtnClickDelegate, MyLabelClickDelegate {
    ...
    func show(tollPrice:String, currentFare:String){
        ...
        let height = 360 + self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_TOLL_PRICE_DESC").height(withConstrainedWidth: width - 30, font: UIFont(name: Fonts().light, size: 17)!) + (self.generalFunc.getLanguageLabel(origValue: "Total toll price:", key: "LBL_TOLL_PRICE_TOTAL").height(withConstrainedWidth: width - 30, font: UIFont(name: Fonts().light, size: 17)!)) - 40
        ...
        tollDesignView.ignoreTollChkBox.tintColor = UIColor.UCAColor.AppThemeColor
        tollDesignView.continueBtn.backgroundColor = UIColor.UCAColor.AppThemeColor 
