...
class Configurations: NSObject {
    ...
    static func getGoogleMapLngCode() -> String{
        let gMapLngCode = GeneralFunctions.getValue(key: Utils.GOOGLE_MAP_LANGUAGE_CODE_KEY)
...
//        defaults.synchronize()
        ...
        GeneralFunctions.saveValue(key: "AppleLanguages", value: [languageCode] as AnyObject)
    }
...
//            print(numStr[i])
    ...
    static func setAppThemeNavBar(){
        ...
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedString.Key.foregroundColor : UIColor.UCAColor.AppThemeTxtColor, NSAttributedString.Key.font: UIFont(name: Fonts().regular, size: 18)!]
        UIApplication.shared.statusBarStyle = UIStatusBarStyle.lightContent
       
    }
    
    static func setDefaultNavBar(){
        //        UINavigationBar.appearance().backgroundColor = UIColor.UCAColor.AppThemeTxtColor
        UINavigationBar.appearance().barTintColor = UIColor.UCAColor.blackColor
        UIBarButtonItem.appearance().tintColor = UIColor.UCAColor.Blue
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedString.Key.foregroundColor : UIColor.UCAColor.blackColor, NSAttributedString.Key.font: UIFont(name: Fonts().regular, size: 18)!]
