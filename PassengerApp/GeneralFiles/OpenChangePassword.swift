...
class OpenChangePassword: NSObject {
    ...
    func show(){
        ...
        changePasswordView = ChangePasswordView(frame: CGRect(x: Application.screenSize.width / 2, y: Application.screenSize.height / 2, width: (Application.screenSize.width > 390 ? 375 : (Application.screenSize.width - 50)), height: 435))
