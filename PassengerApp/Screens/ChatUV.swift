...
class ChatUVd: JSQMessagesViewController {
...
//        + "_" + assignedtripId + "_\(Utils.appUserType)"
        ...
        label.text = "\(receiverDisplayName)\n\(self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_BOOKING") + "#" + self.bookingNo)"
        ...
        inputToolbar.contentView.textView.contentMode = .bottomLeft
        ...
        rightButton.setImage(UIImage(named: "ic_send_msg_arrow")!.withRenderingMode(UIImage.RenderingMode.alwaysTemplate), for: UIControl.State.normal)
