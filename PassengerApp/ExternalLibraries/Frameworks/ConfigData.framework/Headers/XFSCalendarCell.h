...
@class XFSCalendar, XFSCalendarAppearance, XFSCalendarEventIndicator;

typedef NS_ENUM(NSUInteger, XFSCalendarMonthPosition);

@interface XFSCalendarCell : UICollectionViewCell
 ...
 */
@property (weak, nonatomic) XFSCalendarEventIndicator *eventIndicator;
...
@property (weak, nonatomic) XFSCalendarAppearance *appearance;

@property (strong, nonatomic) NSString *subtitle;
@property (strong, nonatomic) UIImage  *image;
@property (assign, nonatomic) XFSCalendarMonthPosition monthPosition;
...
@interface XFSCalendarEventIndicator : UIView
...
@interface XFSCalendarBlankCell : UICollectionViewCell
